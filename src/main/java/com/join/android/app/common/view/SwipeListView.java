        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_CANCEL:
                ...
                if (mIsShown) {
                    ...
                    boolean isTrashTrigger = ((LocalCourseDetailActivity)mCurrentItemView.getContext()).isTrashShowing();
                    if(isTrashTrigger){
                        showRight(mCurrentItemView);
                    }else{
                        if(mIsHorizontal == null || !mIsHorizontal){
                            int p = getPositionForView(mCurrentItemView);
                            Intent intent = new Intent("org.androidannotations.ACTION_2");
