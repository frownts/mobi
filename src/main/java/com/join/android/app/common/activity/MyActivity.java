...
public class MyActivity extends Activity {
    ...
    /**
     *只要前缀是控件id就行，后面随便，如myButton、myButtonOnClicked、myButtonXXXXXX
      */
    @Click
    ...
    void startExtraActivity() {
        Intent intent = ActivityWithExtra_.intent(this).myDate(new Date()).myMessage("hello !").myList("good").get();
//        intent.putExtra(ActivityWithExtra.MY_STRING_EXTRA,"my straa");
